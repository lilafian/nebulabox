...
export function set_clicker_info(
	clicks,
	nlevel,
	nnebulamode,
	ntick,
...
export function set_nebulamode(val) {
	...
	if (nebulamode) {
		...
		document.body.style.animation =
			"nebulamode-gradient 120s infinite";
	}
}
...
export function next_level() {
	...
	display_cursor_notification(
		`dropped ${rarity_to_string(box.rarity)} ${box.name} (now level ${level})`,
	);
